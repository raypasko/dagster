...
from dagster import Bool, Field, Int, String, pipeline, solid


@solid(config={
    'delimiter': Field(
        String, default_value=',', is_optional=True, description=(
            'A one-character string used to separate fields.'
        )
    ),
    'doublequote': Field(
        Bool, default_value=False, is_optional=True, description=(
    ...
    'quoting': Field(
        Int, default_value=csv.QUOTE_MINIMAL, is_optional=True, description=(
    ...
    'strict': Field(
        Bool, default_value=False, is_optional=True, description=(
            'When True, raise exception on bad CSV input.'
        )
    )
})
