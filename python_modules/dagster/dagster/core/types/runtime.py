...
class PythonObjectType(RuntimeType):
    def __init__(self, python_type=None, key=None, name=None, typecheck_metadata_fn=None, type_check=None, **kwargs):
...
PYTHON_DAGSTER_TYPE_ARGS_DOCSTRING = '''Args:
    ...
    type_check (Optional[Callable[[Any], Any]]): If specified, this function will be called in
        ...
        type check succeeds, and otherwise pass. Its return value will be ignored.'''
